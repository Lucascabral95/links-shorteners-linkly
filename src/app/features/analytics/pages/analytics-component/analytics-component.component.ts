import { ChangeDetectionStrategy, Component, inject, signal, ViewChild, AfterViewInit, OnDestroy, ElementRef, ChangeDetectorRef, PLATFORM_ID, OnInit } from '@angular/core';
...
export default class AnalyticsComponentComponent implements AfterViewInit, OnDestroy, OnInit {
